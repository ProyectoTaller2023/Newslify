...
namespace Newslify.Migrations
{
    ...
    [Migration("20231125214556_modificar-readinglist-manager")]
    partial class modificarreadinglistmanager
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KeywordReadingList", b =>
                {
                    ...
                    b.HasKey("KeywordsId", "ReadingListsId");

                    b.HasIndex("ReadingListsId");

                    b.ToTable("KeywordReadingList");
                });

            modelBuilder.Entity("KeywordSavedNew", b =>
                {
                    b.Property<int>("KeywordsId")
                        .HasColumnType("int");

                    b.Property<int>("SavedNewsId")
                        .HasColumnType("int");

                    b.HasKey("KeywordsId", "SavedNewsId");
            ...
            modelBuilder.Entity("Newslify.SavedNews.SavedNew", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppSavedNews", (string)null);
                });

            modelBuilder.Entity("ReadingListSavedNew", b =>
                {
                    b.Property<int>("ReadingListsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ReadingListsId", "SavedNewsId");

                    b.HasIndex("SavedNewsId");

                    b.ToTable("ReadingListSavedNew");
                });
            ...
            modelBuilder.Entity("KeywordReadingList", b =>
                {
                    b.HasOne("Newslify.Keywords.Keyword", null)
                        .WithMany()
                        .HasForeignKey("KeywordsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Newslify.ReadingLists.ReadingList", null)
                        .WithMany()
            ...
            modelBuilder.Entity("KeywordSavedNew", b =>
                {
                    ...
                    b.HasOne("Newslify.SavedNews.SavedNew", null)
                        .WithMany()
